    ...
    return (
        <div className="my-12 sm:px-20 px-6">
            ...
            <div className="flex sm:flex-row flex-col gap-4 my-4 justify-between items-start">
                <div className="sm:w-1/4 w-full min-h-[308px] border flex flex-col py-6 justify-between items-center bg-[#E4E9FB]">
            ...
            <div>
                ...
                <div className="">
                    <div className="flex sm:flex-row flex-col justify-between gap-8">
                        <div className="sm:w-1/4 h-fit p-6 border rounded border-[0.5px] border-[#001B79]">
